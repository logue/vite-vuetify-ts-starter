...
::: warning
`v-date-picker` accepts ISO 8601 **date** strings (_YYYY-MM-DD_). For more information regarding ISO 8601 and other standards, visit the official ISO (International Organization for Standardization) International Standards page.
:::
