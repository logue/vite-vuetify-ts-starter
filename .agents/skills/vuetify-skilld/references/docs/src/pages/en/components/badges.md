...
Inline badges can be placed anywhere with content and can render without a _default_ slot.

<ExamplesExample file="v-badge/prop-inline" />

#### Content

For simple text, use the **content** property to display a _value_ on the badge.
