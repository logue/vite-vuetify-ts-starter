...
May 2025 has been a month of significant progress for Vuetify, with key developments that enhance the framework's capabilities and developer experience. From the official release of Vuetify MCP (Model Context Protocol) to substantial improvements in core components like VDateInput; this month has set the stage for exciting future innovations.

::: success

Cool example of the month: VTreeview File structure by Jacek
...
May brought substantial improvements to several core components, with VDateInput receiving particular attention. The component now features enhanced parsing capabilities, improved validation, and more flexible configuration options. The spotlight for this month is on the VDateInput.
...
- VDateInput input-format PR #21221
- VDateInput menu v-model PR #21298
- VDateInput validationValue PR #21408
- VDateInput common parser PR #21450
- VDateInput disable months/years PR #21466

### VNumberInput

This month also saw multiple updates to the VNumberInput component, including:
...
- VColorInput introduction PR #20623
...
**Details:** Vuetify Play

### Vuetify Issues Next in Testing

We've published the new issue generator for testing, providing a new interface for creating and managing GitHub issues. Please drop us a line in Discord if you have any feedback or suggestions.

**Details:** Issues-next deployment

### Vuetify ESLint Config

v4.0.0 of the Vuetify ESLint config is now available, providing updated linting rules and configurations that align with the latest Vuetify standards and best practices. This major version includes improved TypeScript support and enhanced component-specific rules. The config is automatically included when Creating a new project and is recommended for all Vuetify projects.
...
- **VAutocomplete:** Re-evaluate dirty on external change #21344
- **VBottomNavigation:** Set inline margin to auto #21357
- **VDataTable:** Shift-click toggles only selectable rows #21334
- **VDataTableServer/Virtual:** Add generic headers type #21327
- **VDialog:** Focus on open only with scrim or retainFocus #21343
- **VField:** Prevent tab focus on clear icon #19528
- **VFileInput/VFileUpload:** Fix drop not calling change function #21182
- **VMenu:** Position relative to `visualViewport` when not zoomed #21462
- **VNumberInput:** Adjust inner spacing #21389
- **VNumberInput:** Capture touch pointer on controls #21436
- **VNumberInput:** Extract number from pasted text #21263
- **VOverlay:** Validate target positioning #21350
- **VPagination:** Adapt button width for large values #21139
- **VSelect:** Keyboard match multiple items with same prefix #21419
- **VSelect:** Prevent selection on lookup in multiple mode #21418
- **VSnackbarQueue:** Prevent infinite recursion in message type #21410
- **VTable:** Remove border radius with top/bottom #21320 #21321
- **VTextField:** Reset field on clear #21310
- **VTooltip:** Disable transition when set to false #21268

###  Labs

- **validation:** Resolve global rules #21267
- **VColorInput:** Introduced new component #20623
- **VDateInput:** Accept value on hidden picker #21273
- **VDateInput:** Add `input-format` prop #21221
- **VDateInput:** Add `update-on` prop #21249
- **VDateInput:** Expose menu as `v-model` #21298
- **VDateInput:** Reset model to \[] when multiple #21299
- **VDateInput:** Sync placeholder and locale #21409
- **VDateInput:** Validation sync with `modelValue` #21408
- **VTimePicker:** Fix SSR hydration mismatch #21355

###  Reverts

- Revert fix for **VAutocomplete** dirty state change #21392

###  Code Refactoring

- Resolve directives directly #21413
- Use `clamp()` utility function commit
